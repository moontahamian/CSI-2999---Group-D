...
public class SignUpController {
    ...
    @FXML private PasswordField confirm_password_text;
    @FXML private Label message_label;
    @FXML private Button back_to_log_in_button;
    ...
    private void goToLogin(ActionEvent event) {
        ...
        try {
            Parent root = FXMLLoader.load(
                    getClass().getResource("Log_in.fxml")
            );
    ...
    public void backToLogInBtnClicked(ActionEvent event) {
        goToLogin(event);
    }
}